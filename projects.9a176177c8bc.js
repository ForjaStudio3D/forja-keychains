(() => {
  ...
  const colors = ['#fff0eb', '#eef3ff', '#edf8f0', '#f4f0f7', '#f3f3f5'];
  const count = cards.length, RESUME_MS = 5000, SPEED = .147;
  ...
  async function prepare() {
    ...
    pending = import('./clients-renderer.3cddf7a6511b.js').then(m => m.createClientsViewer(canvas)).then(v => {
