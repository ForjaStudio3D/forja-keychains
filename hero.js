...
(() => {
 const phrase=document.querySelector('#hero-title'),word=phrase.querySelector('.hero-verb'),reduced=matchMedia('(prefers-reduced-motion: reduce)'),words=['usa.','lembra.','compartilha.'];
